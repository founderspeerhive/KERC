...
const Feature = () => {
  ...
  const scrollProgress = Math.max(0, Math.min(1, 
    (scrollY - (sectionTop - viewportHeight)) / (viewportHeight * 0.5)
  ));

  // Reverse progress for entry animation (1 to 0)
  const entryProgress = 1 - scrollProgress;

  return (
    <CurvedSectionTransition
      isEntering={true}
      position="top"
      curveHeight={entryProgress * 100}
      bgColor="transparent"
    ...
    >
      <ResponsiveContainer 
        ...
        style={{
          ...
          borderRadius: `${entryProgress * 30}px`,
          transition: "transform 0.1s ease-out, border-radius 0.1s ease-out",
        }}
      >
        <div className="container mx-auto relative z-10 flex flex-col justify-center h-full py-16">
          <AnimatedElement
            variant="fadeInUp"
            isInView={isInView}
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 p-4 md:p-8 lg:p-12">
            ...
            <AnimatedElement
              ...
              className="md:col-span-2 bg-blue-50 dark:bg-blue-950/50 p-8 rounded-xl flex flex-col justify-between h-full transition-all duration-300 hover:scale-[1.02] hover:shadow-lg"
            >
              <div>
            ...
            >
              <div className="flex flex-col md:flex-row gap-8 items-center">
                <div className="md:w-1/2">
                  ...
                  <Button 
                    className="bg-white text-blue-700 hover:bg-blue-50 transition-all duration-300 hover:scale-[1.05] active:scale-[0.95]"
                  >
                    Buy KERC
                  </Button>
                </div>
